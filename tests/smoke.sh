...
for command in img2webp mytools mytools-doctor mytools-config media-info media-optimize thumloc vid2audio vid2gif vid2webm wav2mp3 wav2tempo webloc2md ytdl; do
